...
\subsection{Giao thức truyền tin MQTT/HTTP}
...
\textbf{a. Giao thức MQTT} \\
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{image/mqtt.png}
...
\textbf{b. Giao thức HTTP} \\
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{image/http.png}
    \caption{Giao thức HTTP }
    \label{fig:placeholder}
\end{figure}
...
Trong khuôn khổ đề tài của nhóm, MQTT và HTTP được xem là các giao thức truyền tin chủ đạo để kết nối thiết bị nhúng với nền tảng CoreIoT, đáp ứng yêu cầu truyền dữ liệu cảm biến, giám sát hệ thống và quản lý thiết bị một cách hiệu quả và ổn định.
